...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Micoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Micoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/micoin-project/micoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Micoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Micoin Core 0.18.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "micoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://micoin.org/"
